...
//        System.out.println("排序前参数:"+new JSONObject(jsonStr).toBean(Map.class));
//        String queryData = SortUtils.parseParam(jsonSort(new JSONObject(jsonStr).toBean(Map.class)));
//        System.out.println("排序后参数:"+queryData);
//    }
    ...
    static Map<String, Object> jsonSort(Map<String, Object> obj) {
    ...
    private static Map<String, Object> objKeySort(Map<String, Object> obj) {
        Map<String, Object> newObj = new TreeMap<>();
        newObj.putAll(obj);
        return newObj;
    }

    private static Map<String, Object> arrayToMap(List<Object> array) {
