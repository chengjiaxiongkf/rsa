...
public class AppMain {
    public static void main(String[] args) throws Exception {
        ...
        // 接口参数
        String data = args.length>0 && !StrUtil.isEmpty(args[0]) ? args[0] : "{ \"kdp_member_number\": \"123\", \"start_date\": \"20200901\", \"end_date\": \"20241130\", \"page\": 1, \"length\": 10, \"key_version\": \"123\", \"sign\": \"123\" }";
