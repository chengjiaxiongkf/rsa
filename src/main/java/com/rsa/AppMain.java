...
public class AppMain {
    public static void main(String[] args) throws Exception {
        ...
        // 接口参数
        String data = args.length>0 && !StrUtil.isEmpty(args[0]) ? args[0] : "{ \"app_key\": \"204229389\", \"timestamp\": \"1698327724\", \"key_version\": \"v9\", \"sign\":\"\" }";
